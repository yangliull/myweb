                    ...
                    <form class="am-form">
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4">
                                <input type="text" class="am-input-sm " name="newTitle">
                            </div>
                        ...
                        <div class="am-g am-margin-top-sm">
                            ...
                            <div class="am-u-sm-12 am-u-md-10">
                                <textarea rows="20" name="newContent" style="width:400px"></textarea>
                            </div>
...
<script src="assets/js/admin_blogNew.js"></script>
</body>
</html>
