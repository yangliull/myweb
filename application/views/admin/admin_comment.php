            ...
            <div class="am-u-sm-12">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <tr>
                        ...
                        <th class="table-email">网址</th>
                        <th class="table-email">博客标题</th>
                        <th class="table-content">评论内容</th>
                    ...
                    foreach($comments as $comment) {
                        ...
                        <tr>
                            ...
                            <td class="table-content"><?php echo $comment -> subject; ?></td>
                            <td><?php echo $comment -> add_time; ?></td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" data-id="<?php echo $comment -> comm_id; ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only cDelete"><span
