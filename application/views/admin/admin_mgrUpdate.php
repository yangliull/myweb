        ...
        <form class="am-form">
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
              <input type="text" class="am-input-sm " name="newName" value="<?php echo $rowm->admin_name; ?>" data-id="<?php echo $rowm->admin_id; ?>">
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
              <input type="password" class="am-input-sm" name="newPwd" value="<?php echo $rowm->admin_pwd; ?>">
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
              <input type="password" class="am-input-sm" name="newPwdT" value="<?php echo $rowm->admin_pwd; ?>">
            </div>
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-12 am-u-md-10">
              <div class="photo" width="200px" ,height="200px" value="<?php echo $rowm->admin_photo; ?>">
              </div>
            </div>
          </div>
        </form>
...
<script src="assets/js/admin_mgrUpdate.js"></script>
</body>
</html>
